...
INSTALL_DIR="/opt/phoenixwings-vps-optimizer"
...
function show_banner() {
    ...
    echo "╔══════════════════════════════════════════════════════════════════╗"
    echo "║                                                                  ║"
    echo "║      🔥🔥  WELCOME TO PHOENIX WINGS VPS OPTIMIZER 🔥🔥         ║"
    echo "║                                                                  ║"
    echo "╠══════════════════════════════════════════════════════════════════╣"
    echo "║    The Fastest, Smartest, and Most Reliable Server Booster!       ║"
    echo "╚══════════════════════════════════════════════════════════════════╝"
    echo -e "${NC}"
    echo ""
}
...
function install_or_update() {
    ...
    git clone https://github.com/PhoenixWings/PhoenixWings-VPS-Optimizer.git "$INSTALL_DIR"

    echo -e "${GREEN}Setting up...${NC}"
    cd "$INSTALL_DIR"
    chmod +x phoenixwings.sh
...
function start_optimizer() {
    echo -e "${YELLOW}Launching Phoenix Wings VPS Optimizer...${NC}"
    sleep 2
    cd "$INSTALL_DIR"
    ./phoenixwings.sh
}
...
function delete_optimizer() {
    echo -e "${RED}Deleting Phoenix Wings VPS Optimizer...${NC}"
    loading_animation
...
echo -e "${GREEN}3) Delete Phoenix Wings VPS Optimizer${NC}"
